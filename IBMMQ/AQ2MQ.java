...
public class AQ2MQ implements MessageListener
{
...
private JMSProducer producer = null;	
    ...
    throws SQLException, JMSException
 {
    ...
    String url = "jdbc:oracle:thin:@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=oradb.sg.oracle.com)))";
    Properties props = new Properties();
    props.setProperty("user", "FCUBS_REST");
